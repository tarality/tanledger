...
import (
	...
	"github.com/tarality/tan-network/consensus/ibft/proto"
	...
	"github.com/tarality/tan-network/syncer"
...
type backendIBFT struct {
	...
	Txs        *state.Txn             // Reference to the state executor
	// tx         *state.Executor        // Reference to the state executor
